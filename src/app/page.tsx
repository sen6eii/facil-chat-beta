...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-verde to-green-600">
      <div className="bg-white p-8 rounded-xl shadow-2xl max-w-md w-full mx-4">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gris-oscuro mb-2">FácilChat</h1>
          ...
          <div className="mt-8 text-sm text-gris-medio">
